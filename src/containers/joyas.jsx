...
}) => 
{
    ...
    const onSubmit = e => {
      e.preventDefault()
      window.scrollTo(0,0);
      get_filtered_joyas(category_id,price_range, sortBy, order)
      setFiltered(true)
    ...
    const showProducts = () => {
      ...
      if (
        filtered_joyas &&
        filtered_joyas !== null &&
        filtered_joyas !== undefined &&
        filtered
      ) {
        filtered_joyas.map((joya, index) => {
            return display.push(
      ...
      if (results.length > 0){
        ...
        return (<h1  >No existen joyas con esas especificaiones</h1>)
      }
      ...
      <div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-10 flex items-baseline justify-between pt-8 pb-6 border-b border-gray-200">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">Joyas</h1>
