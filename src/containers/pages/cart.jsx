...
import { get_items, get_total, get_item_total, remove_item, synch_cart  } from "../../redux/action/cart";
...
export  default connect(mapStatetoprops,{synch_cart, get_user_profiles, get_items, get_item_total,get_total, remove_item }) (Cart)