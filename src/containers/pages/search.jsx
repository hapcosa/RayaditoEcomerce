...
}) => 
{
    ...
    const showProducts = () => {
      ...
      }else if(!filtered && searched_products &&
      ...
      if (results.length > 0){
        ...
        return (<h1  >No existen productos con esas especificaciones</h1>)
      }
                        ...
                        categories.map(category => {
                            if (category.sub_categories.length === 0){
                                ...
                                category.sub_categories.map(sub_category => {
                                    result.push(
                                        <div key={sub_category.id} className='ml-3 flex items-center h-5 my-5'>
                                            <input
                                                onChange={e => onChange(e)}
                    ...
                    }
                    {
                        ...
                        categories_piedras.map(category => {
                            if (category.sub_categories.length === 0){
                                ...
                                category.sub_categories.map(sub_category => {
                                    result.push(
                                        <div key={sub_category.id} className='flex items-center h-5 ml-3 my-5'>
                                            <input
                                                onChange={e => onChange(e)}
                                                value={sub_category.id.toString()}
                                                name='category_id'
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <form onSubmit={e=>onSubmit(e)} className="hidden lg:block">
                ...
                <ul role="list" className="border-l text-sm font-medium text-gray-900 space-y-4 pb-6 border-b border-gray-200">
                <div  className='ml-2 flex items-center h-5 my-5'>
                        <input
                          onChange={e => onChange(e)}
                          value={0}
