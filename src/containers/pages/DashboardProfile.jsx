...
import { update_user_profile, get_user_profiles, delete_user_profile, } from '../../redux/action/profile';
                            ...
                            <div className="w-full h-full ">{/* Place your content here */}
                              <div className="">
                                ...
                                <main className="">
                                  ...
                                  <div className="">
                                  <div className="bg-gray-100  rounded-md  py-5 border-b border-gray-300 sm:px-6 flex">
