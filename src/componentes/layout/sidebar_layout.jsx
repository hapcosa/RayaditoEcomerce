...
{/*
 <div className="flex sm:hidden sm:w-64 md:hidden md:w-64 lg:w-64 xl:w-64 2xl:w-64 absolute sm:relative bg-gray-300 shadow flex-col justify-between ">
                <div className="px-8">
                    <ul className="mt-12">
                        <Link to='/dashboard' className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                
                            
                                <div className="flex items-center">
                                    <UserIcon className="flex h-5 w-5"/>
                                    <p className=" flex text-sm  ml-2">Perfil</p>
                                </div>
                                
                        </Link>
                        
                        <Link to="/dashboard/profile" className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                <BuildingStorefrontIcon className="w-5 h-5"/>
                                <span className="text-sm  ml-2">Direcciones</span>
                            </div>
                        </Link>
                        <Link to="/dashboard/payments"className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                <CreditCardIcon className="w-5 h-5"/>
                                <span className="text-sm  ml-2">Ordenes</span>
                            </div>
                        </Link>
                ...
                <div className="px-8 border-t border-gray-700">
                    <ul className="w-full flex items-center justify-between bg-gray-300">
