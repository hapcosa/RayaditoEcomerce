    ...
    return (
        ...
        <section
          ...
          >
            ...
            <button className=' mt-5 className="ml-8 inline-flex items-center justify-center px-20 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-600 hover:bg-gray-700"'>{loading?<Spinner/>:'Pagar'}</button>
         </form>
        </section>
        </>
