...
class SynchCartView(APIView):
    def put(self, request, format=None):
        ...
        try:
            ...
            if(user.is_anonymous is not False):
                ...
                for cart_item in cart_items:
                    ...
                    try:
                        ...
                        return Response(
                            {'error': 'ID de producto debe ser un entero'},
                            status=status.HTTP_404_NOT_FOUND)
...
class SynchCartProduct(APIView):
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Ha ocurrido un error mientras intenabamos syncronizar su carrito, intente mas tarde'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)