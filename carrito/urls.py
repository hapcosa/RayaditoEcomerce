...
from .views import GetItemsView, AddItemView, GetTotalView, GetItemTotalView, UpdateItemView, RemoveItemView, EmptyCartView, SynchCartProduct
...
urlpatterns = [
    ...
    path('synch', SynchCartProduct.as_view()),
]